                ...
                <div class="card-body">
                    <form action="{{ route('admin.discount.update', $discount->id) }}" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" name="name" value="{{ old('name', $discount->name) }}">   
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" name="code" value="{{ old('code',  $discount->code) }}">    
                            @if ($errors->has('code'))
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" class="form-control" name="percentage" min="1" max="100" value="{{ old('percentage',  $discount->percentage) }}">  
